...
# N: Přeskakuje se stažení souboru „main/binary-amd64/Packages“, protože repositář „https://repo.sdrmap.org/debian bookworm InRelease“ nepodporuje architekturu „amd64“
