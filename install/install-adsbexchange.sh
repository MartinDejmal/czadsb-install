#!/bin/bash
# Skript pro instalaci adsbexchange

# Vychazi z originalniho skriptu. Ten prvne provede nastaveni a pak teprve
# vlastni instalaci podavace a mlat klienta.
#
# Prvni cast (nastaveni) je jiz dana konfiguraci pro CzADSB, proto
# je mozne ji preskocit a hodnoty prevzit z jiz zadanych udaju.


# Konfiguracni soubor pro adsbexchange
CFG_FILE="/etc/default/adsbexchange"

# Vytvoreni, prepsani stavajiciho konfiguracniho souboru
$SUDO touch ${CFG_FILE}
...
# Stazeni a spusteni originalniho skriptu pro instalaci
curl -L -o /tmp/axupdate.sh https://www.adsbexchange.com/feed-update.sh
$SUDO bash /tmp/axupdate.sh
rm /tmp/axupdate.sh

# Da se nasledne doinstalovat web rozhrani - tar1090
# $SUDO bash /usr/local/share/adsbexchange/git/install-or-update-interface.sh

# Pak jeste neco ohledne statistiky
# curl -L -o /tmp/axstats.sh https://adsbexchange.com/stats.sh
# sudo bash /tmp/axstats.sh

# Odkaz pro overeni https://adsbexchange.com/myip/